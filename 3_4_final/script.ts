...

{
    ...
    let showButton: HTMLButtonElement = <HTMLButtonElement>document.getElementById("showfeedback");
    showButton.addEventListener("click", ClickToShowFeedback);

    let serverAnswer: HTMLDivElement = <HTMLDivElement>document.getElementById("feedback");
    let url: string;
